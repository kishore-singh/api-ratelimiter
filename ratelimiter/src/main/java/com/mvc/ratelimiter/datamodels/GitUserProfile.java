...
public class GitUserProfile {
	...
	public String toString() {
		return "GitUserProfile [login=" + login + ", id=" + id + ", node_id=" + node_id + ", avatar_url=" + avatar_url
				...
				+ received_events_url + ", type=" + type + ", site_admin=" + site_admin + ", name=" + name
				+ ", company=" + company + ", blog=" + blog + ", location=" + location + ", email=" + email
				+ ", hireable=" + hireable + ", bio=" + bio + ", public_repos=" + public_repos + ", public_gists="
				+ public_gists + ", followers=" + followers + ", following=" + following + ", created_at=" + created_at
